...
ELASTIC_CONTAINER_NAME = "proces_toevalsvondsten-elastic-init"
ELASTIC_DATA = "$(pwd)/data/elastic"
STORAGE_PROVIDER_IMAGE = "proces_toevalsvondsten-dev/storageprovider:latest"
STORAGE_PROVIDER_CONTAINER_NAME = "storageprovider-init"
STORAGE_PROVIDER_DATA = "$(pwd)/data/storageprovider"
STORAGE_PROVIDER_DATA_MAP = "{}:/proces_toevalsvondsten_store".format(STORAGE_PROVIDER_DATA)
REDIS_IMAGE = "redis"
REDIS_CONTAINER_NAME = "proces_toevalsvondsten-redis-init"
...
def start_redis():
    ...
    _exec_command("docker run "
                  "--link {}:redis "
                  "proces_toevalsvondsten-dev/redis-checker:latest"
...
def start_storage_provider():
    ...
    _exec_command("docker run "
                  ...
                  "proces_toevalsvondsten-dev/storageprovider-checker:latest"
...
def start_elastic():
    ...
    _exec_command("docker run "
                  "--link {}:elastic "
                  "proces_toevalsvondsten-dev/elastic-checker:latest"
                  .format(ELASTIC_CONTAINER_NAME))


def run_elastic_init(git_user, git_pw):
    try:
        ...
        for folder in migrations_folders:
            ...
            try:
                ...
                command = "docker build " \
                          ...
                          "GITPW={} " \
                          "-f {} " \
                          "-t {} .".format(git_user, git_pw, DOCKER_FILE, docker_image_repo)
...
if __name__ == '__main__':
    ...
    run_elastic_init(git_user_name, git_pw)
